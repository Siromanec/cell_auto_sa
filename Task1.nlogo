...
to-report bool-to-num [input-bool]
  ifelse input-bool [
    report 1
  ] [
    report 0
...
to calculate-APAC-for-one-rule
  let cells-alive count patches with[pycor = row and on? = true]
  let cells-total count patches with[pycor = row]
  let apac (cells-alive / cells-total) * 100
  set all-apac all-apac + apac
end
...
to calculate-APAC
  ...
  repeat 200 [
    go
    calculate-APAC-for-one-rule
  ]
  set average all-apac / 200
end
...
521
Langton`s lambda
sum (list (bool-to-num ooo) (bool-to-num ooi) (bool-to-num oio) (bool-to-num oii) (bool-to-num ioo) (bool-to-num ioi) (bool-to-num iio) (bool-to-num iii)) / 8
17
1
11
...
217
623
Average percent of alive cells
average
17
1
11
